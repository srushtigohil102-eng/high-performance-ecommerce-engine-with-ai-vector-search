...
export const productData: SeedProduct[] = [
  ...
  { name: "Trail Running Shoes", description: "Lightweight trail running shoes with cushioned midsole and grippy outsole.", price: 54.99, category: "Clothing", imageUrl: "https://picsum.photos/seed/runningshoes/400/400", stock: 140 },
  { name: "Classic Leather Jacket", description: "Genuine leather moto jacket with quilted lining and zip pockets.", price: 119.99, category: "Clothing", imageUrl: "https://picsum.photos/seed/leatherjacket/400/400", stock: 60 },
  ...
  { name: "Sunscreen SPF 50", description: "Broad-spectrum SPF 50 sunscreen, water-resistant and non-greasy.", price: 13.99, category: "Beauty", imageUrl: "https://picsum.photos/seed/sunscreen/400/400", stock: 250 },
