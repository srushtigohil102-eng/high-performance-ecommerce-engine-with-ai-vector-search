  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-8">
        ...
        <div className="rounded-lg border border-gray-200 p-6 lg:hidden">
        ...
        <div className="sticky bottom-0 -mx-4 border-t border-gray-200 bg-white p-4 lg:hidden">
          ...
          <Link
            to="/cart"
            className="mt-2 block text-center text-sm font-medium text-gray-600 hover:text-gray-900"
          >
            &larr; Back to Cart
          </Link>
        </div>
