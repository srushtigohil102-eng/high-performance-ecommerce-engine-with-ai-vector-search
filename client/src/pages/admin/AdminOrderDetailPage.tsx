  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <div className="mb-6 rounded-lg border border-gray-200 p-4">
        <label htmlFor="status-select" className="mb-2 block text-sm font-semibold text-gray-700">
          Update Status
        </label>
        <div className="flex items-center gap-3">
          <select
            ...
            disabled={updating}
            className="rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900 disabled:opacity-50"
          >
